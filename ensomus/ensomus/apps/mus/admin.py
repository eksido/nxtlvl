...
from models import DevelopmentPlanToUserRelation, QuestionResponse, Question, DevelopmentPlan, DevelopmentPlanType, ReminderTemplate
...
class CompetenceFieldAdmin(CreatedByUpdatedByModelBase):
	list_display = ('title','development_plan_type','language_code','is_manager','company','competence_count','competences')
