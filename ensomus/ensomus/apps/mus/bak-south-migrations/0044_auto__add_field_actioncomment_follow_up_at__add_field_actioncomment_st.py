...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionComment.follow_up_at'
        db.add_column(u'mus_actioncomment', 'follow_up_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ActionComment.status'
        db.add_column(u'mus_actioncomment', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionComment.follow_up_at'
        db.delete_column(u'mus_actioncomment', 'follow_up_at')

        # Deleting field 'ActionComment.status'
        db.delete_column(u'mus_actioncomment', 'status')
