...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActionStatus'
        db.create_table(u'mus_actionstatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'mus', ['ActionStatus'])


        # Renaming column for 'ActionComment.status' to match new field type.
        db.rename_column(u'mus_actioncomment', 'status', 'status_id')
        # Changing field 'ActionComment.status'
        db.alter_column(u'mus_actioncomment', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mus.ActionStatus'], null=True))
        # Adding index on 'ActionComment', fields ['status']
        db.create_index(u'mus_actioncomment', ['status_id'])


        # Renaming column for 'Action.status' to match new field type.
        db.rename_column(u'mus_action', 'status', 'status_id')
        # Changing field 'Action.status'
        db.alter_column(u'mus_action', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mus.ActionStatus'], null=True))
        # Adding index on 'Action', fields ['status']
        db.create_index(u'mus_action', ['status_id'])


    def backwards(self, orm):
        # Removing index on 'Action', fields ['status']
        db.delete_index(u'mus_action', ['status_id'])

        # Removing index on 'ActionComment', fields ['status']
        db.delete_index(u'mus_actioncomment', ['status_id'])

        # Deleting model 'ActionStatus'
        db.delete_table(u'mus_actionstatus')


        # Renaming column for 'ActionComment.status' to match new field type.
        db.rename_column(u'mus_actioncomment', 'status_id', 'status')
        # Changing field 'ActionComment.status'
        db.alter_column(u'mus_actioncomment', 'status', self.gf('django.db.models.fields.IntegerField')())

        # Renaming column for 'Action.status' to match new field type.
        db.rename_column(u'mus_action', 'status_id', 'status')
        # Changing field 'Action.status'
        db.alter_column(u'mus_action', 'status', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'mus.actioncomment': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'action_comment_created_by'", 'to': u"orm['auth.User']"}),
            'follow_up_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mus.ActionStatus']", 'null': 'True', 'blank': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'action_comment_updated_by'", 'to': u"orm['auth.User']"})
        },
        u'mus.actionstatus': {
        ...
        u'mus.developmentplantouserrelation': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'development_plan_user_created_by'", 'to': u"orm['auth.User']"}),
