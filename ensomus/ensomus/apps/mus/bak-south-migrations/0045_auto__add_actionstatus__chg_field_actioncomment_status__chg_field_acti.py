...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column(u'mus_actioncomment', 'status_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mus.ActionStatus'], null=True))
        ...
        db.alter_column(u'mus_action', 'status_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mus.ActionStatus'], null=True))
