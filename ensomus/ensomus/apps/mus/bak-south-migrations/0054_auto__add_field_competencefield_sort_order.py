...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetenceField.sort_order'
        db.add_column(u'mus_competencefield', 'sort_order',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetenceField.sort_order'
        db.delete_column(u'mus_competencefield', 'sort_order')
