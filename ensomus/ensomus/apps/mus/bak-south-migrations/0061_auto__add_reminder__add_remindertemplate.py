...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'mus_reminder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reminder_created_by',
                                                                                 to=orm['auth.User'])),
            ('create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('template', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reminder_template',
                                                                               to=orm['mus.ReminderTemplate'])),
            ...
            ('error', self.gf('django.db.models.fields.CharField')(max_length=500, null=True)),
        ))
        db.send_create_signal(u'mus', ['Reminder'])

        # Adding model 'ReminderTemplate'
        db.create_table(u'mus_remindertemplate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('body', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'mus', ['ReminderTemplate'])


    def backwards(self, orm):
        # Deleting model 'Reminder'
        db.delete_table(u'mus_reminder')

        # Deleting model 'ReminderTemplate'
        db.delete_table(u'mus_remindertemplate')
