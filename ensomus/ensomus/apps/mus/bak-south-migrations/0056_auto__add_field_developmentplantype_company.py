...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'DevelopmentPlanType.company'
        db.add_column(u'mus_developmentplantype', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mus.Company'], null=True,
                                                                            blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DevelopmentPlanType.company'
        db.delete_column(u'mus_developmentplantype', 'company_id')
