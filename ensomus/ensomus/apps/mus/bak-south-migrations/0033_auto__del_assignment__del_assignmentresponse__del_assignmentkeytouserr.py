...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'mus_assignmentresponse')

        # Deleting model 'AssignmentKeyToUserRelation'
        db.delete_table(u'mus_assignmentkeytouserrelation')

        # Deleting model 'AssignmentKey'
        db.delete_table(u'mus_assignmentkey')

        # Deleting field 'DevelopmentPlan.manager_assignment_key_relation'
        db.delete_column(u'mus_developmentplan', 'manager_assignment_key_relation_id')

        # Deleting field 'DevelopmentPlan.employee_assignment_key_relation'
        db.delete_column(u'mus_developmentplan', 'employee_assignment_key_relation_id')
    ...
    def backwards(self, orm):
        ...
        db.send_create_signal(u'mus', ['AssignmentResponse'])

        # Adding model 'AssignmentKeyToUserRelation'
        db.create_table(u'mus_assignmentkeytouserrelation', (
        ...
        db.create_table(u'mus_assignmentkey', (
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal(u'mus', ['AssignmentKey'])
