...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.allow_response'
        db.add_column(u'mus_question', 'allow_response',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.allow_response'
        db.delete_column(u'mus_question', 'allow_response')
