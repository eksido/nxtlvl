...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'mus_questionresponse', 'development_plan_to_user_relation',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='question_response_development_plan_to_user_relation', to=orm['mus.DevelopmentPlanToUserRelation']),
                      keep_default=False)
        ...
        db.alter_column(u'mus_developmentplan', 'manager_response_relation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mus.DevelopmentPlanToUserRelation']))

        # Changing field 'DevelopmentPlan.employee_response_relation'
        db.alter_column(u'mus_developmentplan', 'employee_response_relation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mus.DevelopmentPlanToUserRelation']))
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'mus_questionresponse', 'competence_field_collection_to_user_relation',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='question_response_competence_field_collection_to_user_relation', to=orm['mus.CompetenceFieldCollectionToUserRelation']),
                      keep_default=False)
        ...
        # Changing field 'DevelopmentPlan.manager_response_relation'
        db.alter_column(u'mus_developmentplan', 'manager_response_relation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mus.CompetenceFieldCollectionToUserRelation']))

        # Changing field 'DevelopmentPlan.employee_response_relation'
        db.alter_column(u'mus_developmentplan', 'employee_response_relation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mus.CompetenceFieldCollectionToUserRelation']))
    ...
    models = {
        ...
        u'mus.assignment': {
            ...
            'assignment_key': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'assignments'", 'to': u"orm['mus.AssignmentKey']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'assignment_created_by'", 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {}),
            'title': ('tinymce.models.HTMLField', [], {'null': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'assignment_updated_by'", 'to': u"orm['auth.User']"})
        },
        u'mus.assignmentkey': {
        ...
        u'mus.assignmentkeytouserrelation': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'assignment_key_to_user_relation_created_by'", 'to': u"orm['auth.User']"}),
        ...
        u'mus.assignmentresponse': {
            ...
            'assignment': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'assignment_responses'", 'to': u"orm['mus.Assignment']"}),
            'assignment_key_to_user_relation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'assignment_responses'", 'to': u"orm['mus.AssignmentKeyToUserRelation']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'mus.developmentplan': {
            ...
            'employee_assignment_key_relation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'development_plan_employee_assignment_key_relation'", 'to': u"orm['mus.AssignmentKeyToUserRelation']"}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manager_assignment_key_relation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'development_plan_manager_assignment_key_relation'", 'to': u"orm['mus.AssignmentKeyToUserRelation']"}),
