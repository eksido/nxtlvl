...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DevelopmentPlan.language_code'
        db.add_column(u'mus_developmentplan', 'language_code',
                      self.gf('django.db.models.fields.CharField')(default='en-us', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DevelopmentPlan.language_code'
        db.delete_column(u'mus_developmentplan', 'language_code')
