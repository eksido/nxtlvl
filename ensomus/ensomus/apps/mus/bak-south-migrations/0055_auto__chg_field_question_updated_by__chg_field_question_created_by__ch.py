...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column(u'mus_question', 'updated_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'Question.created_by'
        db.alter_column(u'mus_question', 'created_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'Competence.created_by'
        db.alter_column(u'mus_competence', 'created_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'Competence.updated_by'
        db.alter_column(u'mus_competence', 'updated_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'Company.created_by'
        db.alter_column(u'mus_company', 'created_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'Company.updated_by'
        db.alter_column(u'mus_company', 'updated_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'Action.created_by'
        db.alter_column(u'mus_action', 'created_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'Action.updated_by'
        db.alter_column(u'mus_action', 'updated_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'QuestionResponse.updated_by'
        db.alter_column(u'mus_questionresponse', 'updated_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'QuestionResponse.created_by'
        db.alter_column(u'mus_questionresponse', 'created_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'DevelopmentPlan.created_by'
        db.alter_column(u'mus_developmentplan', 'created_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'ActionComment.updated_by'
        db.alter_column(u'mus_actioncomment', 'updated_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'ActionComment.created_by'
        db.alter_column(u'mus_actioncomment', 'created_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'CompetenceField.created_by'
        db.alter_column(u'mus_competencefield', 'created_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'CompetenceField.updated_by'
        db.alter_column(u'mus_competencefield', 'updated_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'DevelopmentPlanToUserRelation.created_by'
        db.alter_column(u'mus_developmentplantouserrelation', 'created_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'EmployeeRole.created_by'
        db.alter_column(u'mus_employeerole', 'created_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'File.created_by'
        db.alter_column(u'mus_file', 'created_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'Employee.updated_by'
        db.alter_column(u'mus_employee', 'updated_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'Employee.created_by'
        db.alter_column(u'mus_employee', 'created_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'Role.created_by'
        db.alter_column(u'mus_role', 'created_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))

        # Changing field 'Role.updated_by'
        db.alter_column(u'mus_role', 'updated_by_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL,
                                                                              to=orm['auth.User']))
    ...
    def backwards(self, orm):
        ...
        raise RuntimeError(
            "Cannot reverse this migration. 'QuestionResponse.updated_by' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'QuestionResponse.created_by'
        raise RuntimeError(
            "Cannot reverse this migration. 'QuestionResponse.created_by' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DevelopmentPlan.created_by'
        raise RuntimeError(
            "Cannot reverse this migration. 'DevelopmentPlan.created_by' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ActionComment.updated_by'
        raise RuntimeError(
            "Cannot reverse this migration. 'ActionComment.updated_by' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'ActionComment.created_by'
        raise RuntimeError(
            "Cannot reverse this migration. 'ActionComment.created_by' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CompetenceField.created_by'
        raise RuntimeError(
            "Cannot reverse this migration. 'CompetenceField.created_by' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'CompetenceField.updated_by'
        raise RuntimeError(
            "Cannot reverse this migration. 'CompetenceField.updated_by' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DevelopmentPlanToUserRelation.created_by'
        raise RuntimeError(
            "Cannot reverse this migration. 'DevelopmentPlanToUserRelation.created_by' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'EmployeeRole.created_by'
        raise RuntimeError(
            "Cannot reverse this migration. 'EmployeeRole.created_by' and its values cannot be restored.")
