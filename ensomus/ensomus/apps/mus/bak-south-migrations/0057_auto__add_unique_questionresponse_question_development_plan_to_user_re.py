...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding unique constraint on 'QuestionResponse', fields ['question', 'development_plan_to_user_relation']
        db.create_unique(u'mus_questionresponse', ['question_id', 'development_plan_to_user_relation_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'QuestionResponse', fields ['question', 'development_plan_to_user_relation']
        db.delete_unique(u'mus_questionresponse', ['question_id', 'development_plan_to_user_relation_id'])
    ...
    models = {
        ...
        u'mus.questionresponse': {
            'Meta': {'unique_together': "(('question', 'development_plan_to_user_relation'),)",
                     'object_name': 'QuestionResponse'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [],
