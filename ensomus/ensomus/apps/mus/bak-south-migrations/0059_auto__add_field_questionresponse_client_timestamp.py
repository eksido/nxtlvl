...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'QuestionResponse.client_timestamp'
        db.add_column(u'mus_questionresponse', 'client_timestamp',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionResponse.client_timestamp'
        db.delete_column(u'mus_questionresponse', 'client_timestamp')
