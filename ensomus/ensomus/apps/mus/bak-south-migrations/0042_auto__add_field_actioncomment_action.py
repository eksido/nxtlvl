...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActionComment.action'
        db.add_column(u'mus_actioncomment', 'action',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mus.Action'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ActionComment.action'
        db.delete_column(u'mus_actioncomment', 'action_id')
    ...
    models = {
        ...
        u'mus.actioncomment': {
            ...
            'action': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mus.Action']", 'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
