...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'mus.developmentplanpagestatus': {
            ...
            'development_plan_relation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mus.DevelopmentPlanToUserRelation']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'mus.developmentplantype': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mus.Company']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'mus.employee': {
        ...
        u'mus.reminder': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reminder_created_by'", 'to': u"orm['auth.User']"}),
            ...
            'template': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reminder_template'", 'to': u"orm['mus.ReminderTemplate']"})
        },
