...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Deleting field 'ReminderTemplate.body'
        db.delete_column(u'mus_remindertemplate', 'body')

        # Deleting field 'ReminderTemplate.subject'
        db.delete_column(u'mus_remindertemplate', 'subject')

        # Adding field 'ReminderTemplate.subject_en'
        db.add_column(u'mus_remindertemplate', 'subject_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'ReminderTemplate.subject_da'
        db.add_column(u'mus_remindertemplate', 'subject_da',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'ReminderTemplate.body_en'
        db.add_column(u'mus_remindertemplate', 'body_en',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

        # Adding field 'ReminderTemplate.body_da'
        db.add_column(u'mus_remindertemplate', 'body_da',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ReminderTemplate.body'
        db.add_column(u'mus_remindertemplate', 'body',
                      self.gf('django.db.models.fields.TextField')(default='AAAAAA'),
                      keep_default=False)

        # Adding field 'ReminderTemplate.subject'
        db.add_column(u'mus_remindertemplate', 'subject',
                      self.gf('django.db.models.fields.CharField')(default='AAAAAA', max_length=255),
                      keep_default=False)

        # Deleting field 'ReminderTemplate.subject_en'
        db.delete_column(u'mus_remindertemplate', 'subject_en')

        # Deleting field 'ReminderTemplate.subject_da'
        db.delete_column(u'mus_remindertemplate', 'subject_da')

        # Deleting field 'ReminderTemplate.body_en'
        db.delete_column(u'mus_remindertemplate', 'body_en')

        # Deleting field 'ReminderTemplate.body_da'
        db.delete_column(u'mus_remindertemplate', 'body_da')
    ...
    models = {
        ...
        u'mus.action': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'action_created_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [],
                       {'default': '5', 'to': u"orm['mus.ActionStatus']", 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.TextField', [], {}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'action_updated_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"})
        },
        u'mus.actioncomment': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'action_comment_created_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'follow_up_at': (
                'django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.related.ForeignKey', [],
                       {'to': u"orm['mus.ActionStatus']", 'null': 'True', 'blank': 'True'}),
            'text': ('django.db.models.fields.TextField', [], {}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'action_comment_updated_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"})
        },
        u'mus.actionstatus': {
        ...
        u'mus.company': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'company_created_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'company_updated_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"})
        },
        u'mus.competence': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'competence_created_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'competence_updated_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"})
        },
        u'mus.competencefield': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'competence_field_created_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'description': ('tinymce.models.HTMLField', [], {'null': 'True'}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'competence_field_updated_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"})
        },
        u'mus.developmentplan': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'development_plan_created_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
        ...
        u'mus.developmentplanpagestatus': {
            'Meta': {'object_name': 'DevelopmentPlanPageStatus'},
            'development_plan_relation': (
                'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mus.DevelopmentPlanToUserRelation']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pagelink': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'UR'", 'max_length': '2'})
        },
        u'mus.developmentplantouserrelation': {
            'Meta': {'object_name': 'DevelopmentPlanToUserRelation'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'development_plan_user_created_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'finished_at': (
        ...
        u'mus.developmentplantype': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [],
                        {'to': u"orm['mus.Company']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'mus.employee': {
            'Meta': {'object_name': 'Employee'},
            'access_code': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mus.Company']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'employee_created_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            ...
            'newest_development_plan': ('django.db.models.fields.related.ForeignKey', [],
                                        {'to': u"orm['mus.DevelopmentPlan']", 'null': 'True', 'blank': 'True'}),
            'plaintext_password': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'roles': ('django.db.models.fields.related.ManyToManyField', [],
                      {'to': u"orm['mus.Role']", 'through': u"orm['mus.EmployeeRole']", 'symmetrical': 'False'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'employee_updated_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
        ...
        u'mus.employeerole': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'employee_role_created_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            'employee': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mus.Employee']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'mus.file': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'file_created_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
        ...
        u'mus.question': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'question_created_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sort_order': ('django.db.models.fields.IntegerField', [], {}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'question_updated_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"})
        },
        u'mus.questionresponse': {
            'Meta': {'object_name': 'QuestionResponse'},
            'client_timestamp': ('django.db.models.fields.BigIntegerField', [], {'null': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'question_response_created_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            ...
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'question_response_updated_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"})
        },
        u'mus.reminder': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'related_name': "'reminder_created_by'", 'to': u"orm['auth.User']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {}),
            'error': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'send_date': ('django.db.models.fields.DateTimeField', [], {}),
            'sent': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'template': ('django.db.models.fields.related.ForeignKey', [],
                         {'related_name': "'reminder_template'", 'to': u"orm['mus.ReminderTemplate']"})
        },
        u'mus.remindertemplate': {
            'Meta': {'object_name': 'ReminderTemplate'},
            'body_da': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'body_en': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subject_da': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
            'subject_en': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'})
        },
        u'mus.role': {
            'Meta': {'object_name': 'Role'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'role_created_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'updated_by': ('django.db.models.fields.related.ForeignKey', [],
                           {'blank': 'True', 'related_name': "'role_updated_by'", 'null': 'True',
                            'on_delete': 'models.SET_NULL', 'to': u"orm['auth.User']"})
        }
    }
