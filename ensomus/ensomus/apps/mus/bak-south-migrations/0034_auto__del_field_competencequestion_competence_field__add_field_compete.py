...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Deleting field 'CompetenceQuestion.competence_field'
        db.delete_column(u'mus_competencequestion', 'competence_field_id')

        # Adding field 'CompetenceQuestion.competence'
        db.add_column(u'mus_competencequestion', 'competence',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mus.Competence']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CompetenceQuestion.competence_field'
        db.add_column(u'mus_competencequestion', 'competence_field',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mus.CompetenceField']),
                      keep_default=False)

        # Deleting field 'CompetenceQuestion.competence'
        db.delete_column(u'mus_competencequestion', 'competence_id')
