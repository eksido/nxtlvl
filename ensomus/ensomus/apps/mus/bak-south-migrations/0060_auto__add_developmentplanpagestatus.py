...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding model 'DevelopmentPlanPageStatus'
        db.create_table(u'mus_developmentplanpagestatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pagelink', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('development_plan_relation',
             self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mus.DevelopmentPlanToUserRelation'])),
            ('status', self.gf('django.db.models.fields.CharField')(default='UR', max_length=2)),
        ))
        db.send_create_signal(u'mus', ['DevelopmentPlanPageStatus'])


    def backwards(self, orm):
        # Deleting model 'DevelopmentPlanPageStatus'
        db.delete_table(u'mus_developmentplanpagestatus')
