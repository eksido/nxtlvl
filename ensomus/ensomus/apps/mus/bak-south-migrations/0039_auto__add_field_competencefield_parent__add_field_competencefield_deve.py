...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetenceField.parent'
        db.add_column(u'mus_competencefield', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['mus.CompetenceField']),
                      keep_default=False)

        # Adding field 'CompetenceField.development_plan_type'
        db.add_column(u'mus_competencefield', 'development_plan_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mus.DevelopmentPlanType']),
                      keep_default=False)

        # Adding field 'CompetenceField.language_code'
        db.add_column(u'mus_competencefield', 'language_code',
                      self.gf('django.db.models.fields.CharField')(default='en-us', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetenceField.parent'
        db.delete_column(u'mus_competencefield', 'parent_id')

        # Deleting field 'CompetenceField.development_plan_type'
        db.delete_column(u'mus_competencefield', 'development_plan_type_id')

        # Deleting field 'CompetenceField.language_code'
        db.delete_column(u'mus_competencefield', 'language_code')
    ...
    models = {
        ...
        u'mus.competencefield': {
            ...
            'language_code': ('django.db.models.fields.CharField', [], {'default': "'en-us'", 'max_length': '15'}),
