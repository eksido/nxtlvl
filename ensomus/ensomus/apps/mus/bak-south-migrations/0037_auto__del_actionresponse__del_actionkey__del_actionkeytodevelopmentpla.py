...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mus_actioncomment', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='action_comment_created_by', to=orm['auth.User'])),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('updated_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='action_comment_updated_by', to=orm['auth.User'])),
        ))
