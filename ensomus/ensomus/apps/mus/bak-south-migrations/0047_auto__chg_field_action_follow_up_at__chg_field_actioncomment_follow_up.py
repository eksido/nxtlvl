...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Action.follow_up_at'
        db.alter_column(u'mus_action', 'follow_up_at', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'ActionComment.follow_up_at'
        db.alter_column(u'mus_actioncomment', 'follow_up_at', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Action.follow_up_at'
        db.alter_column(u'mus_action', 'follow_up_at', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ActionComment.follow_up_at'
        db.alter_column(u'mus_actioncomment', 'follow_up_at', self.gf('django.db.models.fields.DateTimeField')(null=True))
