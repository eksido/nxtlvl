...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column(u'mus_action', 'type',
                      self.gf('django.db.models.fields.CharField')(max_length=1, null=True),
                      keep_default=False)

        # Adding field 'Action.difficulty'
        db.add_column(u'mus_action', 'difficulty',
                      self.gf('django.db.models.fields.IntegerField')(max_length=1, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Action.type'
        db.delete_column(u'mus_action', 'type')

        # Deleting field 'Action.difficulty'
        db.delete_column(u'mus_action', 'difficulty')
    ...
    models = {
        ...
        u'mus.action': {
            ...
            'difficulty': ('django.db.models.fields.IntegerField', [], {'max_length': '1', 'null': 'True'}),
            ...
            'news_value': ('django.db.models.fields.IntegerField', [], {'max_length': '1', 'null': 'True'}),
