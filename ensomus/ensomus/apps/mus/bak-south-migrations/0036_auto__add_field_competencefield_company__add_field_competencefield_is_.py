...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetenceField.company'
        db.add_column(u'mus_competencefield', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['mus.Company'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'CompetenceField.is_system'
        db.add_column(u'mus_competencefield', 'is_system',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetenceField.company'
        db.delete_column(u'mus_competencefield', 'company_id')

        # Deleting field 'CompetenceField.is_system'
        db.delete_column(u'mus_competencefield', 'is_system')
