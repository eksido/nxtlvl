...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ActionStatus.name'
        db.delete_column(u'mus_actionstatus', 'name')

        # Deleting field 'ActionStatus.language_code'
        db.delete_column(u'mus_actionstatus', 'language_code')

        # Adding field 'ActionStatus.name_da'
        db.add_column(u'mus_actionstatus', 'name_da',
                      self.gf('django.db.models.fields.CharField')(default='Godkend', max_length=30),
                      keep_default=False)

        # Adding field 'ActionStatus.name_en'
        db.add_column(u'mus_actionstatus', 'name_en',
                      self.gf('django.db.models.fields.CharField')(default='Approved', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ActionStatus.name'
        db.add_column(u'mus_actionstatus', 'name',
                      self.gf('django.db.models.fields.CharField')(default='hest', max_length=30),
                      keep_default=False)

        # Adding field 'ActionStatus.language_code'
        db.add_column(u'mus_actionstatus', 'language_code',
                      self.gf('django.db.models.fields.CharField')(default='da', max_length=15),
                      keep_default=False)

        # Deleting field 'ActionStatus.name_da'
        db.delete_column(u'mus_actionstatus', 'name_da')

        # Deleting field 'ActionStatus.name_en'
        db.delete_column(u'mus_actionstatus', 'name_en')
