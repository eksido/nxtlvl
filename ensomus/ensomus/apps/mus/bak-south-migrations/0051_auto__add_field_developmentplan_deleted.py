...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DevelopmentPlan.deleted'
        db.add_column(u'mus_developmentplan', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DevelopmentPlan.deleted'
        db.delete_column(u'mus_developmentplan', 'deleted')
