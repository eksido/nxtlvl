...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Employee.access_code'
        db.add_column(u'mus_employee', 'access_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Employee.access_code'
        db.delete_column(u'mus_employee', 'access_code')
    ...
    models = {
        ...
        u'mus.employee': {
            ...
            'access_code': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
