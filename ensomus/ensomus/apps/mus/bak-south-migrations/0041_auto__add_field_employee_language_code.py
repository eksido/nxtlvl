...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Employee.language_code'
        db.add_column(u'mus_employee', 'language_code',
                      self.gf('django.db.models.fields.CharField')(default='da', max_length=15),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Employee.language_code'
        db.delete_column(u'mus_employee', 'language_code')
