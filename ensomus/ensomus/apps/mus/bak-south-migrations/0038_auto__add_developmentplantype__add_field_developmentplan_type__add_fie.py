...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DevelopmentPlanType'
        db.create_table(u'mus_developmentplantype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'mus', ['DevelopmentPlanType'])

        # Adding field 'DevelopmentPlan.type'
        db.add_column(u'mus_developmentplan', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mus.DevelopmentPlanType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employee.development_plan_type'
        db.add_column(u'mus_employee', 'development_plan_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mus.DevelopmentPlanType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'DevelopmentPlanType'
        db.delete_table(u'mus_developmentplantype')

        # Deleting field 'DevelopmentPlan.type'
        db.delete_column(u'mus_developmentplan', 'type_id')

        # Deleting field 'Employee.development_plan_type'
        db.delete_column(u'mus_employee', 'development_plan_type_id')
