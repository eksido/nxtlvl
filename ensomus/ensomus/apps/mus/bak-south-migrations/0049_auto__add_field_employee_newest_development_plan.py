...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Employee.newest_development_plan'
        db.add_column(u'mus_employee', 'newest_development_plan',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mus.DevelopmentPlan'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Employee.newest_development_plan'
        db.delete_column(u'mus_employee', 'newest_development_plan_id')
