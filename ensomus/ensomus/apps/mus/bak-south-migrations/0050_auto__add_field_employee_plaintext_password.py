...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Employee.plaintext_password'
        db.add_column(u'mus_employee', 'plaintext_password',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Employee.plaintext_password'
        db.delete_column(u'mus_employee', 'plaintext_password')
