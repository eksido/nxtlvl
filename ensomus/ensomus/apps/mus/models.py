...
class Role(models.Model):
	...
	created_by = models.ForeignKey(User, verbose_name=_(u"created by"), related_name='role_created_by',blank=True, null=True, on_delete=models.SET_NULL)
	updated_at = models.DateTimeField(verbose_name=_(u"updated at"),auto_now=True)
	updated_by = models.ForeignKey(User,verbose_name=_(u"updated by"), related_name='role_updated_by',blank=True, null=True, on_delete=models.SET_NULL)
...
class EmployeeRole(models.Model):
	...
	created_at = models.DateTimeField(verbose_name=_(u"created at"),auto_now_add=True)
	created_by = models.ForeignKey(User,verbose_name=_(u"created by"), related_name='employee_role_created_by',blank=True, null=True, on_delete=models.SET_NULL)
...
class Employee(models.Model):
	...
	development_plan_type = models.ForeignKey(DevelopmentPlanType,verbose_name=_("development plan type"), null = True,blank=True)
	newest_development_plan = models.ForeignKey('DevelopmentPlan',verbose_name=_(u'newest_development_plan'),null=True,blank=True)
	...
	created_at = models.DateTimeField(verbose_name=_(u"created at"),auto_now_add = True)
	created_by = models.ForeignKey(User,verbose_name=_(u"created by"), related_name='employee_created_by',blank=True, null=True, on_delete=models.SET_NULL)
	updated_at = models.DateTimeField(verbose_name=_(u"updated at"),auto_now = True)
	updated_by = models.ForeignKey(User,verbose_name=_(u"updated by"), related_name='employee_updated_by',blank=True, null=True, on_delete=models.SET_NULL)
	language_code = models.CharField(max_length=15,verbose_name=_(u'language'),choices=settings.LANGUAGES,default=settings.LANGUAGE_CODE)
	...
	def getMyEmployeesQueryset(self,manager = None):
		...
		if manager is None:
			manager = self
		return Employee.objects.filter(manager__pk=manager.pk,company__pk=self.company.pk).order_by('-is_manager','user__last_name', 'user__first_name')
	...
	def to_json(self):
		...
		return dict(
				...
				manager = (dict() if self.manager == None else dict( id = self.manager.id, name = self.manager.user.get_full_name())),
	...
	def canAssociateNewPlan(self):
		...
		"""
		return DevelopmentPlan.objects.filter(owner__pk=self.pk, employee_response_relation__finished_at=None,manager_response_relation__finished_at=None).exclude(deleted=True).count() == 0
...
class Company(models.Model):
	...
	name = models.CharField(verbose_name=_(u"name"),max_length=255)
	created_at = models.DateTimeField(verbose_name=_(u"created at"),auto_now_add=True)
	created_by = models.ForeignKey(User,verbose_name=_(u"created by"), related_name='company_created_by',blank=True, null=True, on_delete=models.SET_NULL)
	updated_at = models.DateTimeField(verbose_name=_(u"updated at"),auto_now=True)
	updated_by = models.ForeignKey(User,verbose_name=_(u"updated by"), related_name='company_updated_by',blank=True, null=True, on_delete=models.SET_NULL)
...
class CompetenceField(models.Model):
	...
	created_at = models.DateTimeField(verbose_name=_(u"created at"),auto_now_add = True)
	created_by = models.ForeignKey(User,verbose_name=_(u"created by"), related_name='competence_field_created_by',blank=True, null=True, on_delete=models.SET_NULL)
	updated_at = models.DateTimeField(verbose_name=_(u"updated at"),auto_now = True)
	updated_by = models.ForeignKey(User,verbose_name=_(u"updated by"), related_name='competence_field_updated_by',blank=True, null=True, on_delete=models.SET_NULL)
	parent = models.ForeignKey('self',verbose_name=_(u'parent'),related_name='children',null=True,blank=True,limit_choices_to={'parent':None})
...
class Competence(models.Model):
	...
	title = models.CharField(verbose_name=_(u"title"),max_length=4000)
	description = HTMLField(verbose_name=_(u"description"),null = True)
	competence_field = models.ForeignKey(CompetenceField,verbose_name=_(u"competence field"), related_name='competence_competence_field')
	sort_order = models.IntegerField(verbose_name=_(u"sort order"),)
	created_at = models.DateTimeField(verbose_name=_(u"created at"),auto_now_add = True)
	created_by = models.ForeignKey(User,verbose_name=_(u"created by"), related_name='competence_created_by',blank=True, null=True, on_delete=models.SET_NULL)
	updated_at = models.DateTimeField(verbose_name=_(u"updated at"),auto_now = True)
	updated_by = models.ForeignKey(User,verbose_name=_(u"updated by"), related_name='competence_updated_by',blank=True, null=True, on_delete=models.SET_NULL)
...
class Action(models.Model):
	...
	sort_order = models.IntegerField(verbose_name=_(u"sort order"))
	created_at = models.DateTimeField(verbose_name=_(u"created at"),auto_now_add = True)
	created_by = models.ForeignKey(User,verbose_name=_(u"created by"), related_name='action_created_by',blank=True, null=True, on_delete=models.SET_NULL)
	updated_at = models.DateTimeField(verbose_name=_(u"updated at"),auto_now = True)
	updated_by = models.ForeignKey(User,verbose_name=_(u"updated by"), related_name='action_updated_by',blank=True, null=True, on_delete=models.SET_NULL)
...
class ActionComment(models.Model):
	...
	created_at = models.DateTimeField(verbose_name=_(u"created at"),auto_now_add = True)
	created_by = models.ForeignKey(User,verbose_name=_(u"created by"), related_name='action_comment_created_by',blank=True, null=True, on_delete=models.SET_NULL)
	updated_at = models.DateTimeField(verbose_name=_(u"updated at"),auto_now = True)
	updated_by = models.ForeignKey(User,verbose_name=_(u"updated by"), related_name='action_comment_updated_by',blank=True, null=True, on_delete=models.SET_NULL)
...
class Question(models.Model):
	...
	created_at = models.DateTimeField(verbose_name=_(u"created at"),auto_now_add = True)
	created_by = models.ForeignKey(User,verbose_name=_(u"created by"), related_name='question_created_by',blank=True, null=True, on_delete=models.SET_NULL)
	updated_at = models.DateTimeField(verbose_name=_(u"updated at"),auto_now = True)
	updated_by = models.ForeignKey(User,verbose_name=_(u"updated by"), related_name='question_updated_by',blank=True, null=True, on_delete=models.SET_NULL)
	sort_order = models.IntegerField(verbose_name=_(u"sort order"))
...
class DevelopmentPlanToUserRelation(models.Model):
	...
	created_at = models.DateTimeField(verbose_name=_(u"created at"),auto_now_add=True)
	created_by = models.ForeignKey(User,verbose_name=_(u"created by"), related_name='development_plan_user_created_by',blank=True, null=True, on_delete=models.SET_NULL)
	...
	def getPDFfile(self):
		...
		write_pdf(
				'mus/development_plan_pdf.html',
				{
					...
					'extension' : "%s_%s%s" % (development_plan.language_code.lower(),development_plan.type.name.lower()[:-3],self.isManagers() and "_manager" or ""),
	...
	def getStates(self):
		...
		if competence:
			status.append({'link' : '/'+competence.title, 'value': competence.getStatus(self), 'competence_id' : competence.pk})
			result.append({'name': competence.title, 'status': status})

		result.append({'name': _(u'competence key').capitalize(), 'status': [{'link': '/intro-competence', 'value': self.getReadStatus('/intro-competence') }]})
		for competence_field in dp.getCompetenceFields(self):
			status = list()
			status.append({'link' : '/intro-'+competence_field.title, 'value': self.getReadStatus('/intro-'+competence_field.title), 'competence_field_id' : competence_field.pk})
...
class DevelopmentPlanPageStatus(models.Model):
	...
	development_plan_relation = models.ForeignKey(DevelopmentPlanToUserRelation,verbose_name=_('development plan relation'))
	UNREAD = 'UR'
	READ = 'RE'
	STATUS_CHOICES = (
		(UNREAD,_('Unread')),
...
class DevelopmentPlan(models.Model):
	...
	created_at = models.DateTimeField(verbose_name=_(u"created at"),auto_now_add = True)
	created_by = models.ForeignKey(User,verbose_name=_(u"created by"), related_name='development_plan_created_by',blank=True, null=True, on_delete=models.SET_NULL)
	...
	def getFirstCompetenceFromCompetenceFieldId(self,development_plan_relation,cfid):
		...
		cf = CompetenceField.objects.filter(Q(pk=cfid)|Q(parent=cfid),language_code=self.language_code,development_plan_type=self.type,is_manager=is_manager)
	...
	def getCompetenceFields(self,development_plan_relation):
		...
		for cf in self.competence_fields.order_by('sort_order'):
			cfs = CompetenceField.objects.filter(Q(pk=cf.pk)|Q(parent=cf.pk),language_code=self.language_code,development_plan_type=self.type,is_manager=is_manager)
			if cfs:
				fields.append(cfs[0])
		return fields
	...
	def getQuestions(self,development_plan_relation):
		...
		"""
		questions =list()
		for question in self.getAssignmentCompetence(development_plan_relation).question_set.all().order_by('sort_order'):
		...
		for question in self.getEvaluationCompetence(development_plan_relation).question_set.all().order_by('sort_order'):
			questions.append(question)
		return questions
...
class QuestionResponse(models.Model):
	...
	created_at = models.DateTimeField(verbose_name=_(u"created at"),auto_now_add = True)
	created_by = models.ForeignKey(User,verbose_name=_(u"created by"), related_name='question_response_created_by',blank=True, null=True, on_delete=models.SET_NULL)
	updated_at = models.DateTimeField(verbose_name=_(u"updated at"),auto_now = True)
	updated_by = models.ForeignKey(User,verbose_name=_(u"updated by"), related_name='question_response_updated_by',blank=True, null=True, on_delete=models.SET_NULL)
...
class File(models.Model):
	...
	created_by = models.ForeignKey(User, related_name='file_created_by',blank=True, null=True, on_delete=models.SET_NULL)
