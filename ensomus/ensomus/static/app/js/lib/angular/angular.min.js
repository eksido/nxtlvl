...
(function (Y, O, r) {
    ...
    function s(b) {
        return function () {
            var a = arguments[0], c, a = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.2.6/" + (b ? b + "/" : "") + a;
    ...
    function q(b, a, c) {
        var d;
        if (b)if (J(b))for (d in b)"prototype" == d || ("length" == d || "name" == d || b.hasOwnProperty && !b.hasOwnProperty(d)) || a.call(c, b[d], d); else if (b.forEach && b.forEach !== q)b.forEach(a, c); else if (ob(b))for (d = 0; d < b.length; d++)a.call(c, b[d], d); else for (d in b)b.hasOwnProperty(d) && a.call(c, b[d], d);
        return b
    }
    ...
    function ea(b, a) {
        ...
        if (a) {
            if (b ===
                a)throw La("cpi");
            if (I(b))for (var c = a.length = 0; c < b.length; c++)a.push(ea(b[c])); else {
                c = a.$$hashKey;
                q(a, function (b, c) {
                    delete a[c]
                });
    ...
    function ta(b, a) {
        ...
        if (c == typeof a && "object" == c)if (I(b)) {
            ...
            for (d in a)if (!c.hasOwnProperty(d) && "$" !== d.charAt(0) && a[d] !== r && !J(a[d]))return !1;
            return !0
        }
        return !1
    }
    ...
    function rb(b) {
        return va(b, !0).replace(/%26/gi, "&").replace(/%3D/gi,
            "=").replace(/%2B/gi, "+")
    }
    ...
    function vb(b, a, c, d) {
        function e(b) {
            var e = c && b ? [this.filter(b)] : [this], l = a, k, m, n, p, t, w;
            if (!d || null != b)for (; e.length;)for (k = e.shift(), m = 0, n = k.length; m < n; m++)for (p = u(k[m]), l ? p.triggerHandler("$destroy") : l = !l, t = 0, p = (w = p.children()).length; t <
            p; t++)e.push(Aa(w[t]));
    ...
    function ja(b, a, c) {
        var d = b[bb], d = Qa[d || -1];
        if (v(c))d || (b[bb] = d = ++Wc, d = Qa[d] = {}), d[a] = c; else return d && d[a]
    }

    function ac(b,
                a, c) {
        var d = ja(b, "data"), e = v(c), g = !e && v(a), f = g && !V(a);
        d || f || ja(b, "data", d = {});
    ...
    function Yb(b) {
        function a(a) {
            return function (b, c) {
                if (V(b))q(b, Ob(a)); else return a(b, c)
            }
        }
        ...
        function e(a) {
            ...
            q(a, function (a) {
                if (!k.get(a)) {
                    k.put(a, !0);
                    try {
                        if (E(a))for (c = Ta(a), b = b.concat(e(c.requires)).concat(c._runBlocks), d = c._invokeQueue, g = 0, h = d.length; g < h; g++) {
    ...
    function cd(b, a, c, d) {
        ...
        var S = k.href, z = a.find("base"), B = null;
        h.url = function (a, c) {
        ...
        h.onUrlChange = function (a) {
            if (!M) {
                ...
                if (d.hashchange)u(b).on("hashchange", f); else h.addPollFn(f);
                M = !0
            }
            $.push(a);
            return a
        ...
        h.cookies = function (a, b) {
            ...
            Q).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!")); else {
                if (l.cookie !== ka)for (ka = l.cookie, d = ka.split("; "), W = {}, g = 0; g < d.length; g++)e = d[g], h = e.indexOf("="), 0 < h && (a = unescape(e.substring(0, h)), W[a] === r && (W[a] = unescape(e.substring(h + 1))));
                return W
            }
        };
    ...
    function ed() {
        this.$get = function () {
            function b(b, d) {
                ...
                var f = 0, h = x({}, d, {id: b}), l = {}, k = d && d.capacity || Number.MAX_VALUE, m = {}, n = null, p = null;
                return a[b] = {
                    put: function (a, b) {
                        var c = m[a] || (m[a] = {key: a});
                        e(c);
    ...
    function hc(b, a) {
        var c =
        {}, d = "Directive", e = /^\s*directive\:\s*([\d\w\-_]+)\s+(.*)$/, g = /(([\d\w\-_]+)(?:\:([^;]+))?;?)/, f = /^(on[a-z]+|formaction)$/;
        this.directive = function l(a, e) {
            ...
            E(a) ? (sb(e, "directiveFactory"), c.hasOwnProperty(a) || (c[a] = [], b.factory(a + d, ["$injector", "$exceptionHandler", function (b, d) {
                ...
                q(c[a], function (c, g) {
                    try {
                        var f = b.invoke(c);
                        J(f) ? f = {compile: Z(f)} : !f.compile && f.link && (f.compile = Z(f.link));
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate",
            "$$sanitizeUri", function (a, b, m, n, p, t, w, A, F, H, S, z) {
                ...
                function ka(a, b, c, d, f) {
                    ...
                    switch (a.nodeType) {
                        case 1:
                            ...
                            a = a.className;
                            if (E(a) && "" !== a)for (; l = g.exec(a);)n = la(l[2]), T(b, n, "C", d, f) && (c[n] = aa(l[3])), a = a.substr(l.index + l[0].length);
                            break;
                        case 3:
                            s(b, a.nodeValue);
                            break;
                ...
                function ga(a, c, d, e, g, f, l, p, n) {
                    function A(a, b, c, d) {
                        if (a) {
                            c && (a = R(a, c, d));
                            a.require = G.require;
                            if (z === G || G.$$isolateScope)a = ic(a, {isolateScope: !0});
                            l.push(a)
                        }
                        if (b) {
                            c && (b = R(b, c, d));
                            b.require = G.require;
                            if (z === G || G.$$isolateScope)b = ic(b, {isolateScope: !0});
                            p.push(b)
                        }
                    }
                    ...
                    function W(a, e, g, f, n) {
                        ...
                        if (z) {
                            ...
                            q(z.scope, function (a, c) {
                                var d = a.match(ka) || [], g = d[3] || c, f = "?" == d[2], d = d[1], l, m, n, p;
                    ...
                    n = n || {};
                    var F = -Number.MAX_VALUE, M, H = n.controllerDirectives, z = n.newIsolateScopeDirective, ga = n.templateDirective;
                    n = n.nonTlbTranscludeDirective;
                    for (var T = !1, D = !1, x = d.$$element = u(c), G, ba, s, N = e, ma, L = 0, Fa = a.length; L < Fa; L++) {
                        G = a[L];
                        var P = G.$$start, U = G.$$end;
                        P && (x = Q(c, P, U));
                        s = r;
                        ...
                        if (s = G.transclude)T = !0, G.$$tlb || (C("transclusion", n, G, x), n = G), "element" == s ? (D = !0, F = G.priority, s = Q(c, P, U), x = d.$$element = u(O.createComment(" " + ba + ": " + d[ba] + " ")), c = x[0], fb(g, u(ua.call(s, 0)), c), N = B(s, e, F, f && f.name, {nonTlbTranscludeDirective: n})) : (s = u(yb(c)).contents(), x.empty(), N = B(s, e));
                        if (G.template)if (C("template",
                        ...
                        if (G.templateUrl)C("template", ga, G, x), ga = G, G.replace && (f = G), W = y(a.splice(L, a.length - L), x, d, g, N, l, p, {
                            ...
                            Fa = a.length; else if (G.compile)try {
                    ...
                    if (c.hasOwnProperty(e)) {
                        ...
                        for (var w = 0, A = e.length; w < A; w++)try {
                            t = e[w], (f === r || f > t.priority) && -1 != t.restrict.indexOf(g) && (p && (t =
                                Qb(t, {$$start: p, $$end: n})), b.push(t), k = t)
                        } catch (B) {
                            m(B)
                        }
                    }
                ...
                function y(a, b, c, d, e, g, f, l) {
                    ...
                    b.empty();
                    n.get(H.getTrustedResourceUrl(S), {cache: p}).success(function (p) {
                        var n, F;
                        p = X(p);
                        if (A.replace) {
                ...
                var ba = b.startSymbol(), ma = b.endSymbol(), X = "{{" == ba || "}}" == ma ? za : function (a) {
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, b, c, d, n, p) {
            function t(a) {
                ...
                var d = {
                    ...
                    var c = e.headers, d = x({}, a.headers), g, f, c = x({}, c.common, c[C(a.method)]);
                    b(c);
                    b(d);
                    a:for (g in c) {
                        a = C(g);
                        for (f in d)if (C(f) === a)continue a;
                        d[g] = c[g]
                    }
                    return d
                }(a);
            ...
            (function (a) {
                q(arguments, function (a) {
                    t[a] =
                        function (b, c, d) {
                            return t(x(d || {}, {method: a, url: b, data: c}))
                        }
                })
            })("post", "put");
            t.defaults = e;
    ...
    function md(b, a, c, d, e) {
        ...
        return function (e, l, k, m, n, p, t, w) {
            ...
            if (0 < p)var r = c(A, p); else p && p.then && p.then(A)
        }
    }
    ...
    function pd() {
        this.$get = ["$rootScope", "$window", "$q", function (b, a, c) {
            function d(d, f, h, l) {
                var k = a.setInterval, m = a.clearInterval, n = c.defer(), p = n.promise, t = 0, w = v(l) && !l;
                h = v(h) ? h : 0;
                p.then(null, null, d);
                p.$$intervalId =
                    k(function () {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", function (c, d, e, g) {
            ...
            g.on("click", function (a) {
                if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
                    for (var b = u(a.target); "a" !== C(b[0].nodeName);)if (b[0] === g[0] || !(b = b.parent())[0])return;
                    var e = b.prop("href");
            ...
            c.$watch(function () {
                ...
                m && a == h.absUrl() || (m++, c.$evalAsync(function () {
                    c.$broadcast("$locationChangeStart", h.absUrl(), a).defaultPrevented ? h.$$parse(a) :
    ...
    function vc(b, a, c) {
        ...
        if (a.unwrapPromises || 1 !== e)if (a.unwrapPromises ||
            2 !== e)if (a.csp)g = 6 > e ? uc(d[0], d[1], d[2], d[3], d[4], c, a) : function (b, g) {
            var f = 0, h;
        ...
        } else g = vd(d[0], d[1], c); else g = ud(d[0], c);
            ...
            h.prototype = {
                constructor: h, $new: function (a) {
                    ...
                    return this.$watch(function () {
                        e = h(c);
                        var a, b;
                        if (V(e))if (ob(e))for (d !== l && (d = l, m = d.length = 0, f++), a = e.length, m !== a && (f++, d.length =
                            m = a), b = 0; b < a; b++)d[b] !== e[b] && (f++, d[b] = e[b]); else {
                            d !== k && (d = k = {}, m = 0, f++);
                            a = 0;
                    ...
                    var d, f, g, h, k = this.$$asyncQueue, q = this.$$postDigestQueue, r, z, B = b, s, M = [], W, u, v;
                    l("$digest");
                    c = null;
                    do {
                        z = !1;
                        ...
                        a:do {
                            if (h = s.$$watchers)for (r = h.length; r--;)try {
                                if (d = h[r])if ((f = d.get(s)) !== (g = d.last) && !(d.eq ? ta(f, g) : "number" == typeof f && "number" == typeof g && isNaN(f) && isNaN(g)))z = !0, c = d, d.last = d.eq ? ea(f) : f, d.fn(f, g === m ? f : g, s), 5 > B && (W = 4 - B, M[W] || (M[W] = []), u = J(d.exp) ? "fn: " + (d.exp.name || d.exp.toString()) : d.exp, u += "; newVal: " + oa(f) + "; oldVal: " + oa(g), M[W].push(u)); else if (d === c) {
                                    z = !1;
                                    break a
                                }
                            } catch (x) {
                            ...
                            if (!(h = s.$$childHead || s !== this && s.$$nextSibling))for (; s !== this && !(h = s.$$nextSibling);)s =
                                s.$parent
                        } while (s = h);
                    ...
                    }, l = [h].concat(ua.call(arguments, 1)), k, m;
                    do {
                        d = f.$$listeners[a] || c;
                        h.currentScope = f;
                        k = 0;
    ...
    function Ad() {
        ...
        this.$get = function () {
            return function (c, d) {
                var e = d ? a : b, g;
                if (!L || 8 <= L)if (g = pa(c).href, "" !== g && !g.match(e))return "unsafe:" + g;
                return c
            }
        }
    }
            ...
            return {
                trustAs: function (a, b) {
                    ...
                    if (c === da.RESOURCE_URL) {
                        var g = pa(d.toString()), m, n, p = !1;
                        m = 0;
                        for (n = b.length; m < n; m++)if ("self" === b[m] ? Eb(g) : b[m].exec(g.href)) {
                            p = !0;
                            break
                        }
                        if (p)for (m = 0, n = a.length; m < n; m++)if ("self" === a[m] ? Eb(g) : a[m].exec(g.href)) {
                            p = !1;
                            break
                        }
                        if (p)return d;
    ...
    function Ed() {
        this.$get = ["$window", "$document", function (b, a) {
            var c = {}, d = P((/android (\d+)/.exec(C((b.navigator || {}).userAgent)) || [])[1]), e = /Boxee/i.test((b.navigator || {}).userAgent), g = a[0] || {}, f = g.documentMode, h, l = /^(Moz|webkit|O|ms)(?=[A-Z])/, k = g.body && g.body.style,
                m = !1, n = !1;
            if (k) {
    ...
    function Fd() {
        this.$get = ["$rootScope", "$browser", "$q", "$exceptionHandler", function (b, a, c, d) {
            function e(e, h, l) {
                var k = c.defer(), m = k.promise, n = v(l) && !l;
                h = a.defer(function () {
                    try {
                        k.resolve(e())
                    } catch (a) {
    ...
    function Gc(b,
        ...
        var d = this, e = b.parent().controller("form") || lb, g = 0, f = d.$error = {}, h = [];
        ...
        d.$setValidity = function (a,
                                   b, h) {
            var n = f[a];
            if (b)n && (Ka(n, h), n.length || (g--, g || (c(b), d.$valid = !0, d.$invalid = !1), f[a] = !1, c(!0, a), e.$setValidity(a, !0, d))); else {
                g || c(b);
                if (n) {
                    if (-1 != $a(n, h))return
    ...
    function nb(b, a, c, d, e, g) {
        ...
        if (c.ngMinlength) {
            ...
            e = function (a) {
                if (!d.$isEmpty(a) && a.length < p)return d.$setValidity("minlength",
                    !1), r;
    ...
    }, L, u, Aa, ua = [].slice, Pd = [].push, Ya = Object.prototype.toString, La = s("ng"), Na = Y.angular || (Y.angular = {}), Ta, Ea, ia = ["0", "0",
        "0"];
    ...
    }, Qa = N.cache = {}, bb = N.expando = "ng-" + (new Date).getTime(), Wc = 1, Hc = Y.document.addEventListener ? function (b, a, c) {
    ...
    }, Uc = /([\:\-\_]+(.))/g, Vc = /^moz([A-Z])/, wb = s("jqLite"), Da = N.prototype = {
        ready: function (b) {
            function a() {
                c || (c = !0, b())
            }
    ...
    q({
        data: ac,
        inheritedData: cb, scope: function (b) {
            ...
            if (v(c))b.style[a] = c; else {
                ...
                return d
                           ...
                           a, c) {
            var d = C(a);
            if (db[d])if (v(c))c ? (b[a] = !0, b.setAttribute(a, d)) : (b[a] = !1, b.removeAttribute(d)); else return b[a] || (b.attributes.getNamedItem(a) || y).specified ? d : r; else if (v(c))b.setAttribute(a, c); else if (b.getAttribute)return b = b.getAttribute(a, 2), null === b ? r : b
        }, prop: function (b, a, c) {
    ...
    q({
        removeData: Zb, dealoc: Ba, on: function a(c, d, e, g) {
    ...
    var Zc = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, $c = /,/, ad = /^\s*(_?)(\S+?)\1\s*$/, Yc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg, Sa = s("$injector"), Rd = s("$animate"), Sd = ["$provide", function (a) {
        this.$$selectors = {};
    ...
    var gd = /^(x[\:\-_]|data[\:\-_])/i, nd = Y.XMLHttpRequest || function () {
            try {
        ...
        }, nc = s("$interpolate"), Td = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, rd = {
        http: 80,
        https: 443,
        ftp: 21
    }, Gb = s("$location");
    sc.prototype = Hb.prototype = rc.prototype = {
        $$html5: !1, $$replace: !1, absUrl: gb("$$absUrl"),
        url: function (a, c) {
            ...
            this.hash(d[5] || "", c);
            return this
        }, protocol: gb("$$protocol"), host: gb("$$host"), port: gb("$$port"), path: tc("$$path", function (a) {
            ...
            switch (arguments.length) {
                case 0:
                    return this.$$search;
                case 1:
                    if (E(a))this.$$search = Vb(a); else if (V(a))this.$$search = a; else throw Gb("isrcharg");
                    break;
                default:
            ...
            this.$$compose();
            return this
        }, hash: tc("$$hash", za), replace: function () {
            this.$$replace = !0;
            return this
        }
    };
    var xa = s("$parse"), wc = {}, qa, Ia = {
        "null": function () {
            return null
        }, "true": function () {
            return !0
    ...
    Jb.prototype = {
        constructor: Jb, lex: function (a) {
            ...
            for (a = []; this.index < this.text.length;) {
                ...
                if (this.is("\"'"))this.readString(this.ch); else if (this.isNumber(this.ch) ||
                    this.is(".") && this.isNumber(this.peek()))this.readNumber(); else if (this.isIdent(this.ch))this.readIdent(), this.was("{,") && ("{" === a[0] && (c = this.tokens[this.tokens.length - 1])) && (c.json = -1 === c.text.indexOf(".")); else if (this.is("(){}[].,;:?"))this.tokens.push({
                    index: this.index,
                    text: this.ch,
                    ...
                    var d = this.ch + this.peek(),
                        e = d + this.peek(2), g = Ia[this.ch], f = Ia[d], h = Ia[e];
                    h ? (this.tokens.push({
                        index: this.index,
                        text: e,
                        fn: h
        ...
        readIdent: function () {
            ...
            d = {index: d, text: c};
            if (Ia.hasOwnProperty(c))d.fn = Ia[c], d.json = Ia[c]; else {
            ...
            for (var d = "", e = a, g = !1; this.index < this.text.length;) {
                ...
                if (g)"u" === f ? (f = this.text.substring(this.index + 1, this.index + 5), f.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + f + "]"), this.index +=
                    4, d += String.fromCharCode(parseInt(f, 16))) : d = (g = Ud[f]) ? d + g : d + f, g = !1; else if ("\\" === f)g = !0; else {
                    if (f === a) {
                        this.index++;
                        this.tokens.push({
    ...
    Wa.prototype = {
        constructor: Wa, parse: function (a, c) {
            this.text = a;
            this.json = c;
    ...
    var Ib = {}, ra = s("$sce"), da = {
        ...
        JS: "js"
    }, X = O.createElement("a"), yc = pa(Y.location.href, !0);
    zc.$inject = ["$provide"];
    Ac.$inject = ["$locale"];
    Cc.$inject = ["$locale"];
    var Fc = ".", Od = {
    ...
    var lb = {$addControl: y, $removeControl: y, $setValidity: y, $setDirty: y, $setPristine: y};
    Gc.$inject = ["$element", "$attrs", "$scope"];
    var Ic = function (a) {
            return ["$timeout", function (c) {
                return {
                    name: "form", restrict: a ? "EAC" : "E", controller: Gc, compile: function () {
                        return {
        ...
        }, Wd = Ic(), Xd = Ic(!0), Yd = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, Zd = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,6}$/, $d = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Jc = {
            text: nb, number: function (a, c, d, e, g,
                                        f) {
                nb(a, c, d, e, g, f);
                ...
                d.max && (a = function (a) {
                    ...
                    if (!e.$isEmpty(a) && a > c)return e.$setValidity("max",
                        !1), r;
                    e.$setValidity("max", !0);
                    return a
                }, e.$parsers.push(a), e.$formatters.push(a));
                ...
                nb(a, c, d, e, g, f);
                a = function (a) {
                    if (e.$isEmpty(a) || Zd.test(a))return e.$setValidity("email",
                        !0), a;
            ...
            }, hidden: y, button: y, submit: y, reset: y
        ...
        }], kb = "ng-valid", jb = "ng-invalid", Ha = "ng-pristine", mb = "ng-dirty", ae = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", function (a, c, d, e, g) {
            function f(a, c) {
                c = c ? "-" + ab(c, "-") :
                    "";
            ...
            var k = e.inheritedData("$formController") || lb, m = 0, n = this.$error = {};
            e.addClass(Ha);
            f(!0);
            this.$setValidity =
                function (a, c) {
            ...
            return {
                require: ["ngModel", "^?form"], controller: ae, link: function (a, c, d, e) {
                    var g = e[0], f = e[1] || lb;
                    f.$addControl(g);
        ...
        }], je = Lb("", !0), ke = Lb("Odd", 0), le = Lb("Even", 1), me = sa({
    ...
    var oe = ["$animate", function (a) {
            ...
            return {
                ...
                compile: function (f, h) {
                    var l = h.ngInclude || h.src, k = h.onload || "", m =
                        h.autoscroll;
                    return function (f, h, q, r, A) {
                        var s = 0, u, x, z = function () {
                            u && (u.$destroy(), u = null);
                            x && (e.leave(x), x = null)
                        };
            ...
            return {
                restrict: "ECA",
                priority: -400, require: "ngInclude", link: function (c, d, e, g) {
                    d.html(g.template);
                    a(d.contents())(c)
                }
            }
            ...
            return {
                transclude: "element", priority: 1E3, terminal: !0, $$tlb: !0, link: function (e, g, f, h, l) {
                    ...
                    e.$watchCollection(h, function (a) {
                        var f, h, m = g[0], n, v = {}, H, R, E, y, T, C, I = [];
                        if (ob(a))T = a, n = p || t; else {
                            n = p || r;
                            T = [];
                        ...
                        h = I.length = T.length;
                        for (f =
                                 0; f < h; f++)if (E = a === T ? f : T[f], y = a[E], y = n(E, y, f), wa(y, "`track by` id"), D.hasOwnProperty(y))C = D[y], delete D[y], v[y] = C, I[f] = C; else {
        ...
        we = ["$animate", function (a) {
            ...
            transclude: "element", priority: 800, require: "^ngSwitch", link: function (a, c, d, e,
                                                                                        g) {
                e.cases["?"] = e.cases["?"] || [];
        ...
        }], De = s("ngOptions"), Ee = Z({terminal: !0}), Fe = ["$compile", "$parse", function (a, c) {
            var d =
                /^\s*(.*?)(?:\s+as\s+(.*?))?(?:\s+group\s+by\s+(.*))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+(.*?)(?:\s+track\s+by\s+(.*?))?$/, e = {$setViewValue: y};
            return {
                restrict: "E",
                ...
                link: function (e, f, h, l) {
                    ...
                    function n(e, f, g) {
                        function h() {
                            ...
                            s = g.$modelValue;
                            w = x(e) || [];
                            var B = n ? Nb(w) : w, D, K, z;
                            K =
                            {};
                            r = !1;
                            var F, J;
                            if (t)if (u && I(s))for (r = new Ra([]), z = 0; z < s.length; z++)K[m] = s[z], r.put(u(e, K), s[z]); else r = new Ra(s);
                            for (z = 0; D = B.length, z < D; z++) {
                                ...
                                F = l(e, K);
                                F = v(F) ? F : "";
                                k.push({id: u ? u(e, K) : n ? B[z] : z, label: F, selected: d})
                            }
                            ...
                            for (B = c.length; K < B; K++) {
                                ...
                                F = null;
                                z = 0;
                                for (D = k.length; z < D; z++)r = k[z], (d = w[z + 1]) ? (F = d.element, d.label !== r.label && F.text(d.label = r.label), d.id !== r.id && F.val(d.id = r.id), F[0].selected !== r.selected && F.prop("selected", d.selected = r.selected)) : ("" === r.id && A ? J = A : (J = C.clone()).val(r.id).attr("selected", r.selected).text(r.label),
                                    w.push({
                                        element: J,
                                        label: r.label,
                                        id: r.id,
                        ...
                        f.on("change", function () {
                            e.$apply(function () {
                                var a, c = x(e) || [], d = {}, h, k, l,
                                    p, s, w, v;
                                if (t)for (k = [], p = 0, w = y.length; p < w; p++)for (a = y[p], l = 1, s = a.length; l < s; l++) {
                                ...
                                } else if (h = f.val(), "?" == h)k = r; else if ("" === h)k = null; else if (u)for (v = 0; v < c.length; v++) {
                                    if (d[m] = c[v], u(e, d) == h) {
                                        k = q(e, d);
                                        break
                                    }
                    ...
                    if (l[1]) {
                        var p = l[0];
                        l = l[1];
                        var t = h.multiple, s = h.ngOptions, A = !1, x, C = u(O.createElement("option")),
                            E = u(O.createElement("optgroup")), y = C.clone();
                        h = 0;
                        for (var B = f.children(), J = B.length; h < J; h++)if ("" === B[h].value) {
                            x = A = B.eq(h);
                            break
                        }
                        p.init(l, A, y);
    ...
    (function (a) {
        ...
        Ta("ng", ["ngLocale"], ["$provide", function (a) {
            ...
            a.provider("$compile", hc).directive({
                ...
                ngRequired: Lc,
                ngValue: fe
            }).directive({ngInclude: qe}).directive(Mb).directive(Mc);
            a.provider({
                $anchorScroll: bd,
                $animate: Sd,
                $browser: dd,
